  ...
  return (
    <>
      <div className="flex flex-col px-36">
        ...
        <div className="my-44 ">
          <h1 className="text-3xl font-semibold flex gap-1 w-full justify-center mb-8">
          ...
          <div className="flex">
            <div>
              ...
              <div className="flex pr-8 text-justify gap-8 mt-12">
                <div className="w-1/2">
                  <h2 className="text-xl font-medium text-[#2245e3] mb-2">
                    ¿Quiénes somos?
                  </h2>
                  <p>
                ...
                <div className="w-1/2">
                  <h2 className="text-xl font-medium text-[#00ad10] mb-2">
                    ¿Porqué elegirnos?
                  </h2>
          ...
          <div className="flex flex-col">
            <div className="flex gap-36">
              <div className="self-center">
                <h1 className="text-2xl font-semibold">Salas térmicas</h1>
                ...
                <Button className="bg-[#2245e3]">Contizar</Button>
              </div>
              <Image
            ...
            <div className="flex gap-36 mt-24">
              ...
              />
              <div className="self-center">
                <h1 className="text-2xl font-semibold">Sala de bombas</h1>
                <p className="text-justify my-4">
                ...
                <Button className="bg-[#00ad10]">Contizar</Button>
              </div>
            </div>
            <div className="flex gap-36 mt-24">
              <div className="self-center">
                <h1 className="text-2xl font-semibold">Grupo electrógeno</h1>
                <p className="text-justify my-4">
            ...
            <div className="flex gap-36 mt-24">
              ...
              />
              <div className="self-center">
                <h1 className="text-2xl font-semibold">Paneles Solares</h1>
                <p className="text-justify my-4">
            ...
            <div className="flex gap-36 mt-24">
              <div className="self-center">
                <h1 className="text-2xl font-semibold">Aguas Servidas</h1>
                <p className="text-justify my-4">
        ...
        <div className="mt-40 flex">
          ...
          <div className="w-2/3 ml-8">
            <h1 className="text-2xl font-semibold text-[#2245e3] mb-3">
              Beneficios Clave
            </h1>
      ...
      <footer className="mt-20 h-64 bg-[#2245e3] w-full flex items-start justify-between text-white p-10">
        {/* Logotipo y nombre */}
